...
import { SEASONS_UPCOMING } from "../utils";
...
const SeasonsUpcoming: FC = () => {
	/* A hook that is used to fetch data from an API. */
	const { data, isLoading, error } = useSWR(SEASONS_UPCOMING, fetcher, {
		suspense: true,
	});

	const topAnime: [] = data.data;
	const title = "Upcoming Series";
...
export default SeasonsUpcoming;
